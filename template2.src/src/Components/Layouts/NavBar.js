...
const NavBar = () => {
    ...
    <AppBar position="static" className={classes.AppBar}>
        ...
        <NavLink className={classes.links} activeClassName={classes.active} to="/page5">Five</NavLink>
        <NavLink className={classes.links} activeClassName={classes.active} to="/page6">Six</NavLink>
        </Toolbar>
    </Typography>
    </AppBar>
